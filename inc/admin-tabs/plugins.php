...
$options_panel->addCheckbox( 
    ...
    array(
        ...
        'desc' => __( "You'd probably be better deleting them alltogether... Also, this one doesn't work for multisite.", 'mtt' ),
        'std'  => false
    )
);
...
$options_panel->addCheckbox( 
    ...
    array(
        ...
        'desc' => sprintf( __( 'Incorporation of the plugin: %s. After enabling this, the first load of the plugins page may take a while for the information be retrieved. After the first load, the information is cached.', 'mtt' ), MTT_Plugin_Utils::make_tip_credit( 'Plugin Last Updated', 'http://wordpress.org/extend/plugins/plugin-last-updated/' ) ) ,
        'std'  => false
    )
);
