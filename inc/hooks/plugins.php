...
if ( !class_exists( 'MTT_Hook_Plugins' ) ):
    ...
    class MTT_Hook_Plugins
    {
        ...
        public function plugins_list_modify()
        {
            ...
            $reset_bg = '.plugins .inactive, .plugins .inactive th, .plugins .inactive td, tr.inactive + tr.plugin-update-tr .plugin-update {background-color:transparent;}';
            ...
            if( $exclusive_plugins )
            {
                if( // not correct, bail out
                    empty( $this->params['plugins_my_plugins_bg_color']['names'] ) 
                    || empty( $this->params['plugins_my_plugins_bg_color']['color'] )
                    || '#' == $this->params['plugins_my_plugins_bg_color']['color']
                )
                    return;
