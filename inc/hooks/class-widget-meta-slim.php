...
class WP_Widget_Meta_Slim extends WP_Widget
{
    ...
    function form( $instance )
    {
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo $this->get_field_id( 'link1_title' ); ?>" name="<?php echo $this->get_field_name( 'link1_title' ); ?>" type="text" value="<?php echo esc_attr( $link1_title ); ?>" />
        </p>
        <p>
            ...
            <input class="widefat" id="<?php echo $this->get_field_id( 'link1_url' ); ?>" name="<?php echo $this->get_field_name( 'link1_url' ); ?>" type="text" value="<?php echo esc_attr( $link1_url ); ?>" />
        </p>
        <?php
    }
