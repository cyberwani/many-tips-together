...
if ( !class_exists( 'MTT_Hook_Post_Editing' ) ):
class MTT_Hook_Post_Editing
{
    ...
    public function __construct( $options )
    {
        ...
        if ( !empty( $options['postpages_move_author_metabox'] ) )
        {
            add_action( 
                    'admin_menu', 
                    array( $this, 'autor_metabox_remove' ) 
            );
            add_action( 
                    'post_submitbox_misc_actions', 
                    array( $this, 'autor_metabox_move' ) 
            );
        }
        ...
        if ( !empty( $options['postpages_move_comments_metabox'] ) )
        {
            add_action( 
                    'add_meta_boxes', 
                    array( $this, 'comments_metabox_remove' ) 
            );
            add_action( 
                    'post_submitbox_misc_actions', 
                    array( $this, 'comments_metabox_move' ) 
            );
        }
    ...
    public function all_metabox_remove()
    {
        ...
        {
            //loga('postpages_move_comments_metabox WORKING');
