...
if( !class_exists( 'MTT_Hook_Maintenance' ) ):
    ...
    class MTT_Hook_Maintenance
    {
        ...
        public function do_maintenance()
        {
            ...
            $ucan  = MTT_Plugin_Utils::maintenance_user_level( $level );
            ...
            if( !current_user_can( $ucan ) )
            {
                ...
                // IMAGES
                $theUrl = MTT_Plugin_Init::get_url();
                ...
                if( !empty( $this->params['maintenance_mode_enable']['extra_css'] ) )
                    $extraCss = ('.class-name {}' != $this->params['maintenance_mode_enable']['extra_css'] ) 
